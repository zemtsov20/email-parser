...
public class Parser_old {
    ...
    public static HashSet<String> parse(String url, int depth) {
        Deque<Node> urlQueue = new ArrayDeque<>();
        ...
        while (!urlQueue.isEmpty()) {
            ...
            Parser_old.emailsFromPage(allEmails, htmlContent);
            ...
            Parser_old.urlsFromPage(urlQueue, addedUrls, htmlContent, siteToMatch, addToHref, node1.getDepth());
        }
